                          ...
                          int pipelineDepth, int iterations, int threadId)
{
    ...
    for (int iter = 0; iter < iterations; iter++) {
        ...
        // redisAppendCommand(conn, "UNSUBSCRIBE channel channel1 channel2 channel3");

        // (3) Append a BLPOP command.
        // redisAppendCommand(conn, "XREAD BLOCK 1 STREAMS mystream 1526999626221-0");
        redisAppendCommand(conn, "GET KEY1 KEY2 KEY3");
        redisAppendCommand(conn, "GETT KEY1 KEY2 KEY3");
