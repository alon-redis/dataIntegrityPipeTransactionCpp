...
3. dataIntegrityPipelinedWithBlpop.cpp
   * performs X SET/GET commands in pipeline + BLPOP/HSET/HGET sequance in the end of the pipeline
4. dataIntegrityPipelinedWithInfoBlpop.cpp
   * performs X SET/GET commands in pipeline + INFO/BLPOP/HSET/HGET sequance in the end of the pipeline
